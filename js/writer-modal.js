...
async function fetchWriterInfo() {
    ...
    writers.forEach(writer => {
        ...
        if(hire_date === null & position === "Shadow") {
            ...
            hire_date_formatted = new Date(hire_date).toLocaleDateString("en-US", {month: "long", day: "numeric", year: "numeric"});
        }
        ...
        if(end_date === null) {
            ...
            end_date_formatted = new Date(end_date).toLocaleDateString("en-US", {month: "long", day: "numeric", year: "numeric"});
        }
        ...
        <div class="list-options">
            <div class = "list-option" onclick = "openEditWriterModal(writer)">Edit</div>
            <div class = "list-option" onclick = "deleteWriter(writer.writer_id)">Delete</div>
        </div>
